    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <FormSection @submitted="addTeamMember">
                <template #title> Add Workspace Member </template>

                <template #description>
                    Add a new workspace member to your workspace, allowing them
                ...
                <template #form>
                    <div class="col-span-6">
                        ...
                        >
                            ...
                            would like to add to this workspace.
                        </div>
                    </div>
        ...
        >
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title> Pending Workspace Invitations </template>

                <template #description>
                    These people have been invited to your workspace and have
                    been sent an invitation email. They may join the workspace
                    by accepting the email invitation.
                </template>

                <!-- Pending Workspace Member Invitation List -->
                <template #content>
                    <div class="space-y-6">
                        <div
        ...
        <div v-if="team.users.length > 0">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title> Workspace Members </template>
        ...
        >
            <template #title> Leave Workspace </template>
        ...
        >
            <template #title> Remove Workspace Member </template>
